...
CREATE TABLE IF NOT EXISTS resources (
  ...
  type            TEXT    NOT NULL
                          CHECK (type IN (
                            ...
                            'AMBULANCE','EMERGENCY_ROOM','MRI_MACHINE',
                            'OXYGEN_CONCENTRATOR','BLOOD_BANK','CT_SCANNER','DEFIBRILLATOR'
                          )),
  name            TEXT    NOT NULL,
...
INSERT INTO resources (hospital_id, type, name, status, specialization, location) VALUES
  ...
  ('11111111-0000-0000-0000-000000000001','MRI_MACHINE','MRI-01','AVAILABLE',NULL,'Radiology'),
  ('11111111-0000-0000-0000-000000000001','OXYGEN_CONCENTRATOR','OXY-01','AVAILABLE',NULL,'ICU'),
  ...
  ('11111111-0000-0000-0000-000000000002','CT_SCANNER','CT-C01','AVAILABLE',NULL,'Radiology'),
  ...
  ('11111111-0000-0000-0000-000000000003','OXYGEN_CONCENTRATOR','OXY-Y01','AVAILABLE',NULL,'ICU'),
